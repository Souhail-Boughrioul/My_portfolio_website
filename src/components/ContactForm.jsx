        ...
        <motion.form
            ...
            <div className='mb-4'>
                    <textarea 
                        ...
                        className='mb-8 w-full appearance-none rounded-lg border border-stone-50/30 
                        bg-transparent
                        px-3 py-2 text-sm focus:border-stone-400 focus:outline-none' rows='6' />
                        {errors.message && (
                            <motion.p 
                                initial={{opacity: 0}}
            ...
            <button type='submit' className={`mb-8 w-full rounded border border-stone-50/30 bg-stone-200
